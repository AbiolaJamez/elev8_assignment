...
return point;
    ...
    public static void main(String[] args) {
        ...
        String grade5 = ds.collectGrade(Score5);
         ...
         int point1 = ds.collectPoint(grade1);
         int point2 = ds.collectPoint(grade2);
         int point3 = ds.collectPoint(grade3);
         int point4 = ds.collectPoint(grade4);
         int point5 = ds.collectPoint(grade5);
         
         
    int totalGradeUnit= gradeUnit1+gradeUnit2+gradeUnit3+gradeUnit4+gradeUnit5;
    int totalQualityPoint=point1*gradeUnit1;
